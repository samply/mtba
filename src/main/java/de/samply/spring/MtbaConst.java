...
public class MtbaConst {
  ...
  public final static String PATIENT_CSV_FILENAME_SV = HEAD_SV + PATIENT_CSV_FILENAME + ":#{'data_clinical_patient.txt'}" + BOTTOM_SV;
  public final static String PATIENT_CSV_PATIENT_ID_HEADER_SV = HEAD_SV + PATIENT_CSV_PATIENT_ID_HEADER + ":#{'PATIENT_ID'}" + BOTTOM_SV;
  public final static String PATIENT_CSV_LOCAL_ID_HEADER_SV = HEAD_SV + PATIENT_CSV_LOCAL_ID_HEADER + ":#{null}" + BOTTOM_SV;
  public final static String PATIENT_CSV_FIRST_NAME_HEADER_SV = HEAD_SV + PATIENT_CSV_FIRST_NAME_HEADER + ":#{null}" + BOTTOM_SV;
  public final static String PATIENT_CSV_LAST_NAME_HEADER_SV = HEAD_SV + PATIENT_CSV_LAST_NAME_HEADER + ":#{null}" + BOTTOM_SV;
  public final static String PATIENT_CSV_PREVIOUS_NAMES_HEADER_SV = HEAD_SV + PATIENT_CSV_PREVIOUS_NAMES_HEADER + ":#{null}" + BOTTOM_SV;
  public final static String PATIENT_CSV_BIRTHDAY_HEADER_SV = HEAD_SV + PATIENT_CSV_BIRTHDAY_HEADER + ":#{null}" + BOTTOM_SV;
  public final static String PATIENT_CSV_CITIZENSHIP_HEADER_SV = HEAD_SV + PATIENT_CSV_CITIZENSHIP_HEADER + ":#{null}" + BOTTOM_SV;
  public final static String PATIENT_CSV_GENDER_HEADER_SV = HEAD_SV + PATIENT_CSV_GENDER_HEADER + ":#{null}" + BOTTOM_SV;
  public final static String MUTATIONS_CSV_FILENAME_SV = HEAD_SV + MUTATIONS_CSV_FILENAME + ":#{'data_mutations_extended.txt'}" + BOTTOM_SV;
  public final static String MUTATIONS_CSV_SAMPLE_ID_HEADER_SV = HEAD_SV + MUTATIONS_CSV_SAMPLE_ID_HEADER + ":#{'Tumor_Sample_Barcode'}" + BOTTOM_SV;
  public final static String MUTATIONS_CSV_SCRIPT_INTERPRETER_SV = HEAD_SV + MUTATIONS_CSV_SCRIPT_INTERPRETER + ":#{'python'}" + BOTTOM_SV;
