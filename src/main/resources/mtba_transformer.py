...
def convert_row(row):
    ...
    resource= (f'<id value="{identifier}" />' +
               ...
               generateFHIR('48018-6', genename)+
               generateFHIR('48005-3', aminoacidchange)+
               generateFHIR('81290-9', DNAchange)+
               #generateFHIR('81248-7', SeqRef_NCBI)+
               generateFHIR('81249-5', EnsemblID)
               )
